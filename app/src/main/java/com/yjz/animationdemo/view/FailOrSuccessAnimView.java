 ...
 * Time:2017/4/10.
 */
public class FailOrSuccessAnimView extends View {
    ...
    public FailOrSuccessAnimView(Context context) {
        super(context);
        init();
    }

    public FailOrSuccessAnimView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FailOrSuccessAnimView(Context context, AttributeSet attrs, int defStyleAttr) {
