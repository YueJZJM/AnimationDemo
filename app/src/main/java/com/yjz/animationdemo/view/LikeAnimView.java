 ...
 * Time:2017/4/10.
 */
public class LikeAnimView extends FrameLayout implements View.OnClickListener {
    ...
    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.like_anim_view, this, true);
    ...
    public void onClick(View v) {
        isChecked = !isChecked;
        mIvStar.setImageResource(isChecked ? R.drawable.star_on : R.drawable.star_off);
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        if (isChecked) {
